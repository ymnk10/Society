...
var opening = function () {
    $(window).on("load", function () {
        $(window).delay(500).queue(function () {
            $(".js-act").addClass("is-act"), $(".p-kv__parking").delay(1200).queue(function () {
                $(this).addClass("js-delay")
            })
        })
    })
},
    sliderOptions = function () {
        $(".js-informationSlider").slick({
            autoplay: !0,
            fade: !0,
            autoplaySpeed: 5e3,
            dots: !0
    ...
    drawer = function () {
        $(".hamburger").on("click", function () {
            ...
            n.find("span").toggleClass("hidden"), n.toggleClass("is-act"), $("body,html").toggleClass("is-open"), $(".js-spNav").slideToggle()
        }), $(".js-spNav").find("a").on("click", function () {
            $(".js-spNav").slideToggle(0), $(".hamburger").toggleClass("is-act"), $(".hamburger").find("span").toggleClass("hidden")
        })
    };
! function (n) {
    n(function () {
        opening(), sliderOptions(), window.matchMedia("(max-width:767px)").matches && drawer()
    }), n(window).on("load resize", function () { }), n(window).on("scroll", function () { })
}(jQuery);
"use strict";
